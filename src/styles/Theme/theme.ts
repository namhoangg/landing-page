...
const color = {
  ...
  YELLOW_GRADIENT: 'linear-gradient(88.88deg, #F3C300 30.82%, #F79520 55.87%, #F1592C 75.79%)',
  YELLOW_GRADIENT_2: 'linear-gradient(90deg, #F3C300 11.89%, #F79520 97.8%)',
  YELLOW_GRADIENT_3: 'linear-gradient(89deg, #F3C300 39.93%, #F79520 76.36%, #F1592C 96.86%)',
...
const antdTheme: ThemeConfig = {
  token: {
    ...
    fontFamily: '__Inter_948ae8,system-ui,Avenir,Helvetica,Arial,sans-serif!important',
    boxShadow: 'none',
...
export { antdTheme, theme, fontSize, fontWeight, color, breakPoint, breakPointValue, zIndex };
